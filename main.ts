...
class Student {
    static counter = 20000; // Initialize the static counter
    id: number;
    name: string;
    courses: string[];
    balance: number;
    ...
    show_status() {
        ...
        console.log(chalk.greenBright(`Courses: ${this.courses.join(", ")}`));
...
async function main() {
    console.log(chalk.yellowBright("Welcome to 'Farzana Shah' - Student Management System"));
